...
const FriendCard = ({ friend }) => {
    ...
    return (
        ...
        <Link to={`/details/${friend.id}`}>
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm text-center flex flex-col items-center hover:shadow-md transition-shadow cursor-pointer">
